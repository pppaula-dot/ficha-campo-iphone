const CACHE='ficha-campo-iphone-v0.1.0';
const CORE=['./','./index.html','./pwa-bridge.js','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
